      ...
      <section className="w-full max-w-md bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Log in to your household</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="text-center text-sm">
            <Link to="/forgot-password" className="text-teal-800 hover:underline font-medium">
              Forgot password?
            </Link>
          </p>
        </form>
        ...
        <p className="mt-4 text-xs text-slate-500 text-center">
          Demo account: alex@example.com / Password1!
        </p>
      </section>
    </main>
  )
